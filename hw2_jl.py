...
controls = dbc.Card(
    [
        ...
        # dbc.Row([
        #     html.Button('Submit', id='submit-blotter', n_clicks=0,
    ...
    [
        ...
        dbc.Row(
            [
                ...
                # dbc.Col(html.Img(src='data:image/png;base64,{}'.format(test_base64)), md=8, width='auto')
            ],
            align="center",
        ),
...
def render_trade_blotter(n_clicks, start_date, end_date, asset):
    ...
    # IF LOWEST TRADED PRICE > BID PRICE
    ...
    submitted_exit_orders['price'] = round(filled_entry_orders['price'] * (1 + alpha1), 2)
